...
const Text = ({ className, color = 'secondary', flex, children, ...rest }) => {
    return (jsx(TextWrapper, { className: clsx('MuiText-' + color, { flexItem: flex }), ...rest, children: children }));
};
Text.propTypes = {
...
sxHeader, sxSubTitle, gutterBottom, }) => {
    ...
    return (jsx(Fragment, { children: jsx(Box, { sx: [
                {
                    p: theme.spacing(3, 4),
                    mb: theme.spacing(2),
                },
            ], children: jsxs(Grid, { container: true, justifyContent: "space-between", alignItems: "center", children: [jsxs(Grid, { item: true, children: [jsx(Typography, { variant: variant ? variant : 'h1', component: component ? component : 'h1', sx: sxHeader, gutterBottom: gutterBottom, style: { lineHeight: 1.4 }, children: headingText }), jsx(Typography, { variant: variantSubTitle ? variantSubTitle : 'subtitle1', sx: sxSubTitle, style: { lineHeight: 1.4 }, children: subtitleText })] }), jsx(Grid, { item: true, children: AdditionalProps })] }) }) }));
};
 ...
 */
const AddToolTip = styled$1(Tooltip)(() => `
  .MuiTooltip-popper{
...
divider, dividerSx, }) => {
    const theme = useTheme();
    return (jsx(Fragment, { children: jsxs(Box, { sx: {
                margin: noMargin
                    ? theme.spacing(0)
                    : mbSmall
                ...
                ...sx,
            }, children: [jsxs(Grid, { container: true, justifyContent: "space-between", alignItems: "center", sx: { mb: noMargin ? 0 : 1 }, children: [jsxs(Grid, { item: true, sx: style, children: [jsxs(Typography, { variant: variant, component: component ? component : 'div', sx: sxHeader, gutterBottom: gutterBottom, style: { lineHeight: 1.5 }, children: [headingText, TooltipTitleIconComponent && (jsx(AddToolTip, { title: TooltipTitleIconComponent, arrow: true, placement: "top-start", children: jsx(Button, { sx: {
                                                    margin: '0 0 .2em 0',
                                                    '&.MuiButton-root': {
                                                        padding: '6px',
...
const colors$6 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemHeadingColor: darken(themeColors$6.secondary, 0.3),
        },
    },
    alpha: {
        white: {
            5: alpha(themeColors$6.white, 0.02),
            10: alpha(themeColors$6.white, 0.1),
            30: alpha(themeColors$6.white, 0.3),
            50: alpha(themeColors$6.white, 0.5),
            70: alpha(themeColors$6.white, 0.7),
            100: themeColors$6.white,
        },
        trueWhite: {
            5: alpha(themeColors$6.trueWhite, 0.02),
            10: alpha(themeColors$6.trueWhite, 0.1),
            30: alpha(themeColors$6.trueWhite, 0.3),
            50: alpha(themeColors$6.trueWhite, 0.5),
            70: alpha(themeColors$6.trueWhite, 0.7),
            100: themeColors$6.trueWhite,
        },
        black: {
            5: alpha(themeColors$6.black, 0.02),
            10: alpha(themeColors$6.black, 0.1),
            30: alpha(themeColors$6.black, 0.3),
            50: alpha(themeColors$6.black, 0.5),
            70: alpha(themeColors$6.black, 0.7),
            100: themeColors$6.black,
        },
    },
    secondary: {
        lighter: alpha(themeColors$6.secondary, 0.85),
        light: alpha(themeColors$6.secondary, 0.6),
        main: themeColors$6.secondary,
        dark: darken(themeColors$6.secondary, 0.2),
    },
    primary: {
        lighter: alpha(themeColors$6.primary, 0.85),
        light: alpha(themeColors$6.primary, 0.3),
        main: themeColors$6.primary,
        dark: darken(themeColors$6.primary, 0.2),
    },
    success: {
        lighter: alpha(themeColors$6.success, 0.85),
        light: alpha(themeColors$6.success, 0.3),
        main: themeColors$6.success,
        dark: darken(themeColors$6.success, 0.2),
    },
    warning: {
        lighter: alpha(themeColors$6.warning, 0.85),
        light: alpha(themeColors$6.warning, 0.3),
        main: themeColors$6.warning,
        dark: darken(themeColors$6.warning, 0.2),
    },
    error: {
        lighter: alpha(themeColors$6.error, 0.85),
        light: alpha(themeColors$6.error, 0.3),
        main: themeColors$6.error,
        dark: darken(themeColors$6.error, 0.2),
    },
    info: {
        lighter: alpha(themeColors$6.info, 0.85),
        light: alpha(themeColors$6.info, 0.3),
        main: themeColors$6.info,
        dark: darken(themeColors$6.info, 0.2),
    },
};
const DarkSpacesTheme = createTheme({
    ...
    colors: {
        ...
        secondary: {
            lighter: alpha(themeColors$6.secondary, 0.1),
            light: alpha(themeColors$6.secondary, 0.3),
            main: themeColors$6.secondary,
            dark: darken(themeColors$6.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$6.primary, 0.1),
            light: alpha(themeColors$6.primary, 0.3),
            main: themeColors$6.primary,
            dark: darken(themeColors$6.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$6.success, 0.1),
            light: alpha(themeColors$6.success, 0.3),
            main: themeColors$6.success,
            dark: darken(themeColors$6.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$6.warning, 0.1),
            light: alpha(themeColors$6.warning, 0.3),
            main: themeColors$6.warning,
            dark: darken(themeColors$6.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$6.error, 0.1),
            light: alpha(themeColors$6.error, 0.3),
            main: themeColors$6.error,
            dark: darken(themeColors$6.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$6.info, 0.1),
            light: alpha(themeColors$6.info, 0.3),
            main: themeColors$6.info,
            dark: darken(themeColors$6.info, 0.2),
        },
    ...
    components: {
        ...
        MuiDialog: {
            styleOverrides: {
                paper: {
                    backgroundColor: darken(themeColors$6.primaryAlt, 0.5),
                },
            },
        },
        MuiCssBaseline: {
            ...
            styleOverrides: {
                root: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$6.primary.lighter, 0.2),
                    },
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$6.alpha.black[100],
                            background: alpha(colors$6.primary.lighter, 0.2),
                        },
                    },
                },
            },
        ...
        MuiAutocomplete: {
            styleOverrides: {
                ...
                clearIndicator: {
                    background: alpha(colors$6.error.lighter, 0.2),
                    color: colors$6.error.main,
                    marginRight: 8,
                    '&:hover': {
                        background: alpha(colors$6.error.lighter, 0.3),
                    },
                },
                popupIndicator: {
                    color: colors$6.alpha.black[70],
            ...
            styleOverrides: {
                ...
                root: {
                    ...
                    '&.MuiTableRow-hover:hover': {
                        backgroundColor: alpha(colors$6.alpha.black[5], 0.05),
                    },
                },
            },
        },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$6.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$6.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
...
const colors$5 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemIconColorActive: '#ffffff',
            menuItemHeadingColor: darken(themeColors$5.secondary, 0.3),
        },
    },
    alpha: {
        white: {
            5: alpha(themeColors$5.white, 0.02),
            10: alpha(themeColors$5.white, 0.1),
            30: alpha(themeColors$5.white, 0.3),
            50: alpha(themeColors$5.white, 0.5),
            70: alpha(themeColors$5.white, 0.7),
            100: themeColors$5.white,
        },
        trueWhite: {
            5: alpha(themeColors$5.trueWhite, 0.02),
            10: alpha(themeColors$5.trueWhite, 0.1),
            30: alpha(themeColors$5.trueWhite, 0.3),
            50: alpha(themeColors$5.trueWhite, 0.5),
            70: alpha(themeColors$5.trueWhite, 0.7),
            100: themeColors$5.trueWhite,
        },
        black: {
            5: alpha(themeColors$5.black, 0.02),
            10: alpha(themeColors$5.black, 0.1),
            30: alpha(themeColors$5.black, 0.3),
            50: alpha(themeColors$5.black, 0.5),
            70: alpha(themeColors$5.black, 0.7),
            100: themeColors$5.black,
        },
    },
    secondary: {
        lighter: alpha(themeColors$5.secondary, 0.85),
        light: alpha(themeColors$5.secondary, 0.6),
        main: themeColors$5.secondary,
        dark: darken(themeColors$5.secondary, 0.2),
    },
    primary: {
        lighter: alpha(themeColors$5.primary, 0.85),
        light: alpha(themeColors$5.primary, 0.3),
        main: themeColors$5.primary,
        dark: darken(themeColors$5.primary, 0.2),
    },
    success: {
        lighter: alpha(themeColors$5.success, 0.85),
        light: alpha(themeColors$5.success, 0.3),
        main: themeColors$5.success,
        dark: darken(themeColors$5.success, 0.2),
    },
    warning: {
        lighter: alpha(themeColors$5.warning, 0.85),
        light: alpha(themeColors$5.warning, 0.3),
        main: themeColors$5.warning,
        dark: darken(themeColors$5.warning, 0.2),
    },
    error: {
        lighter: alpha(themeColors$5.error, 0.85),
        light: alpha(themeColors$5.error, 0.3),
        main: themeColors$5.error,
        dark: darken(themeColors$5.error, 0.2),
    },
    info: {
        lighter: alpha(themeColors$5.info, 0.85),
        light: alpha(themeColors$5.info, 0.3),
        main: themeColors$5.info,
        dark: darken(themeColors$5.info, 0.2),
    },
};
const GreenFieldsTheme = createTheme({
    // direction: i18n.dir(),
    colors: {
        gradients: {
        ...
        secondary: {
            lighter: alpha(themeColors$5.secondary, 0.1),
            light: alpha(themeColors$5.secondary, 0.3),
            main: themeColors$5.secondary,
            dark: darken(themeColors$5.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$5.primary, 0.1),
            light: alpha(themeColors$5.primary, 0.3),
            main: themeColors$5.primary,
            dark: darken(themeColors$5.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$5.success, 0.1),
            light: alpha(themeColors$5.success, 0.3),
            main: themeColors$5.success,
            dark: darken(themeColors$5.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$5.warning, 0.1),
            light: alpha(themeColors$5.warning, 0.3),
            main: themeColors$5.warning,
            dark: darken(themeColors$5.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$5.error, 0.1),
            light: alpha(themeColors$5.error, 0.3),
            main: themeColors$5.error,
            dark: darken(themeColors$5.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$5.info, 0.1),
            light: alpha(themeColors$5.info, 0.3),
            main: themeColors$5.info,
            dark: darken(themeColors$5.info, 0.2),
        },
    ...
    components: {
        ...
        MuiDialog: {
            styleOverrides: {
                paper: {
                    backgroundColor: darken(themeColors$5.primaryAlt, 0.5),
                },
            },
        },
        MuiCssBaseline: {
        ...
        MuiList: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$5.primary.lighter, 0.2),
                    },
                    '& .MuiMenuItem-root.MuiButtonBase-root .MuiTouchRipple-root': {
                        opacity: 0.2,
                    },
            ...
            styleOverrides: {
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$5.alpha.black[100],
                            background: alpha(colors$5.primary.lighter, 0.2),
                        },
                    },
                },
            },
        ...
        MuiAutocomplete: {
            styleOverrides: {
                ...
                clearIndicator: {
                    background: alpha(colors$5.error.lighter, 0.2),
                    color: colors$5.error.main,
                    marginRight: 8,
                    '&:hover': {
                        background: alpha(colors$5.error.lighter, 0.3),
                    },
                },
                popupIndicator: {
                    color: colors$5.alpha.black[70],
        ...
        MuiTableRow: {
            styleOverrides: {
                ...
                root: {
                    transition: 'background-color .2s',
                    '&.MuiTableRow-hover:hover': {
                        backgroundColor: alpha(colors$5.alpha.black[5], 0.05),
                    },
                },
            },
        },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$5.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$5.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
...
const colors$4 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemIconColor: lighten(themeColors$4.secondary, 0.3),
            menuItemIconColorActive: themeColors$4.primary,
            menuItemHeadingColor: darken(themeColors$4.secondary, 0.3),
        },
    },
    alpha: {
        white: {
            5: alpha(themeColors$4.white, 0.02),
            10: alpha(themeColors$4.white, 0.1),
            30: alpha(themeColors$4.white, 0.3),
            50: alpha(themeColors$4.white, 0.5),
            70: alpha(themeColors$4.white, 0.7),
        ...
        black: {
            5: alpha(themeColors$4.black, 0.02),
            10: alpha(themeColors$4.black, 0.1),
            30: alpha(themeColors$4.black, 0.3),
            50: alpha(themeColors$4.black, 0.5),
            70: alpha(themeColors$4.black, 0.7),
            100: themeColors$4.black,
        },
    },
    secondary: {
        lighter: lighten(themeColors$4.secondary, 0.85),
        light: lighten(themeColors$4.secondary, 0.25),
        main: themeColors$4.secondary,
        dark: darken(themeColors$4.secondary, 0.2),
    },
    primary: {
        lighter: lighten(themeColors$4.primary, 0.85),
        light: lighten(themeColors$4.primary, 0.3),
        main: themeColors$4.primary,
        dark: darken(themeColors$4.primary, 0.2),
    },
    success: {
        lighter: lighten(themeColors$4.success, 0.85),
        light: lighten(themeColors$4.success, 0.3),
        main: themeColors$4.success,
        dark: darken(themeColors$4.success, 0.2),
    },
    warning: {
        lighter: lighten(themeColors$4.warning, 0.85),
        light: lighten(themeColors$4.warning, 0.3),
        main: themeColors$4.warning,
        dark: darken(themeColors$4.warning, 0.2),
    },
    error: {
        lighter: lighten(themeColors$4.error, 0.85),
        light: lighten(themeColors$4.error, 0.3),
        main: themeColors$4.error,
        dark: darken(themeColors$4.error, 0.2),
    },
    info: {
        lighter: lighten(themeColors$4.info, 0.85),
        light: lighten(themeColors$4.info, 0.3),
        main: themeColors$4.info,
        dark: darken(themeColors$4.info, 0.2),
    },
};
const GreyGooseTheme = createTheme({
    // direction: i18n.dir(),
    colors: {
        gradients: {
        ...
        secondary: {
            lighter: alpha(themeColors$4.secondary, 0.1),
            light: lighten(themeColors$4.secondary, 0.3),
            main: themeColors$4.secondary,
            dark: darken(themeColors$4.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$4.primary, 0.1),
            light: lighten(themeColors$4.primary, 0.3),
            main: themeColors$4.primary,
            dark: darken(themeColors$4.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$4.success, 0.1),
            light: lighten(themeColors$4.success, 0.3),
            main: themeColors$4.success,
            dark: darken(themeColors$4.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$4.warning, 0.1),
            light: lighten(themeColors$4.warning, 0.3),
            main: themeColors$4.warning,
            dark: darken(themeColors$4.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$4.error, 0.1),
            light: lighten(themeColors$4.error, 0.3),
            main: themeColors$4.error,
            dark: darken(themeColors$4.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$4.info, 0.1),
            light: lighten(themeColors$4.info, 0.3),
            main: themeColors$4.info,
            dark: darken(themeColors$4.info, 0.2),
        },
    ...
    components: {
        MuiBackdrop: {
            styleOverrides: {
                root: {
                    backgroundColor: alpha(darken(themeColors$4.primaryAlt, 0.4), 0.2),
                    backdropFilter: 'blur(2px)',
                    '&.MuiBackdrop-invisible': {
                        backgroundColor: 'transparent',
                        backdropFilter: 'blur(2px)',
        ...
        MuiList: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiListItem-root.MuiButtonBase-root.Mui-selected': {
                        backgroundColor: alpha(colors$4.primary.lighter, 0.4),
                    },
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$4.primary.lighter, 0.4),
                    },
            ...
            styleOverrides: {
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$4.alpha.black[100],
                            background: alpha(colors$4.primary.lighter, 0.4),
                        },
                    },
                },
            },
            ...
            styleOverrides: {
                root: {
                    '&.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$4.alpha.black[100],
                            background: lighten(colors$4.primary.lighter, 0.5),
                        },
                    },
                },
            },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$4.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$4.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
...
const colors$3 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemIconColorActive: '#ffffff',
            menuItemHeadingColor: darken(themeColors$3.secondary, 0.3),
        },
    },
    alpha: {
        white: {
            5: alpha(themeColors$3.white, 0.02),
            10: alpha(themeColors$3.white, 0.1),
            30: alpha(themeColors$3.white, 0.3),
            50: alpha(themeColors$3.white, 0.5),
            70: alpha(themeColors$3.white, 0.7),
            100: themeColors$3.white,
        },
        trueWhite: {
            5: alpha(themeColors$3.trueWhite, 0.02),
            10: alpha(themeColors$3.trueWhite, 0.1),
            30: alpha(themeColors$3.trueWhite, 0.3),
            50: alpha(themeColors$3.trueWhite, 0.5),
            70: alpha(themeColors$3.trueWhite, 0.7),
            100: themeColors$3.trueWhite,
        },
        black: {
            5: alpha(themeColors$3.black, 0.02),
            10: alpha(themeColors$3.black, 0.1),
            30: alpha(themeColors$3.black, 0.3),
            50: alpha(themeColors$3.black, 0.5),
            70: alpha(themeColors$3.black, 0.7),
            100: themeColors$3.black,
        },
    },
    secondary: {
        lighter: alpha(themeColors$3.secondary, 0.85),
        light: alpha(themeColors$3.secondary, 0.6),
        main: themeColors$3.secondary,
        dark: darken(themeColors$3.secondary, 0.2),
    },
    primary: {
        lighter: alpha(themeColors$3.primary, 0.85),
        light: alpha(themeColors$3.primary, 0.3),
        main: themeColors$3.primary,
        dark: darken(themeColors$3.primary, 0.2),
    },
    success: {
        lighter: alpha(themeColors$3.success, 0.85),
        light: alpha(themeColors$3.success, 0.3),
        main: themeColors$3.success,
        dark: darken(themeColors$3.success, 0.2),
    },
    warning: {
        lighter: alpha(themeColors$3.warning, 0.85),
        light: alpha(themeColors$3.warning, 0.3),
        main: themeColors$3.warning,
        dark: darken(themeColors$3.warning, 0.2),
    },
    error: {
        lighter: alpha(themeColors$3.error, 0.85),
        light: alpha(themeColors$3.error, 0.3),
        main: themeColors$3.error,
        dark: darken(themeColors$3.error, 0.2),
    },
    info: {
        lighter: alpha(themeColors$3.info, 0.85),
        light: alpha(themeColors$3.info, 0.3),
        main: themeColors$3.info,
        dark: darken(themeColors$3.info, 0.2),
    },
};
const NebulaFighterTheme = createTheme({
    ...
    colors: {
        ...
        secondary: {
            lighter: alpha(themeColors$3.secondary, 0.1),
            light: alpha(themeColors$3.secondary, 0.3),
            main: themeColors$3.secondary,
            dark: darken(themeColors$3.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$3.primary, 0.1),
            light: alpha(themeColors$3.primary, 0.3),
            main: themeColors$3.primary,
            dark: darken(themeColors$3.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$3.success, 0.1),
            light: alpha(themeColors$3.success, 0.3),
            main: themeColors$3.success,
            dark: darken(themeColors$3.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$3.warning, 0.1),
            light: alpha(themeColors$3.warning, 0.3),
            main: themeColors$3.warning,
            dark: darken(themeColors$3.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$3.error, 0.1),
            light: alpha(themeColors$3.error, 0.3),
            main: themeColors$3.error,
            dark: darken(themeColors$3.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$3.info, 0.1),
            light: alpha(themeColors$3.info, 0.3),
            main: themeColors$3.info,
            dark: darken(themeColors$3.info, 0.2),
        },
    ...
    components: {
        ...
        MuiDialog: {
            styleOverrides: {
                paper: {
                    backgroundColor: darken(themeColors$3.primaryAlt, 0.5),
                },
            },
        },
        MuiCssBaseline: {
        ...
        MuiList: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$3.primary.lighter, 0.2),
                    },
                    '& .MuiMenuItem-root.MuiButtonBase-root .MuiTouchRipple-root': {
                        opacity: 0.2,
                    },
            ...
            styleOverrides: {
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$3.alpha.black[100],
                            background: alpha(colors$3.primary.lighter, 0.2),
                        },
                    },
                },
            },
        ...
        MuiAutocomplete: {
            styleOverrides: {
                ...
                clearIndicator: {
                    background: alpha(colors$3.error.lighter, 0.2),
                    color: colors$3.error.main,
                    marginRight: 8,
                    '&:hover': {
                        background: alpha(colors$3.error.lighter, 0.3),
                    },
                },
                popupIndicator: {
                    color: colors$3.alpha.black[70],
        ...
        MuiTableRow: {
            styleOverrides: {
                ...
                root: {
                    transition: 'background-color .2s',
                    '&.MuiTableRow-hover:hover': {
                        backgroundColor: alpha(colors$3.alpha.black[5], 0.05),
                    },
                },
            },
        },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$3.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$3.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
...
const colors$2 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemBgActive: '#f2f5f9',
            menuItemIconColor: lighten(themeColors$2.secondary, 0.3),
            menuItemIconColorActive: themeColors$2.primary,
            menuItemHeadingColor: darken(themeColors$2.secondary, 0.3),
        },
    },
    alpha: {
        white: {
            5: alpha(themeColors$2.white, 0.02),
            10: alpha(themeColors$2.white, 0.1),
            30: alpha(themeColors$2.white, 0.3),
            50: alpha(themeColors$2.white, 0.5),
            70: alpha(themeColors$2.white, 0.7),
        ...
        black: {
            5: alpha(themeColors$2.black, 0.02),
            10: alpha(themeColors$2.black, 0.1),
            30: alpha(themeColors$2.black, 0.3),
            50: alpha(themeColors$2.black, 0.5),
            70: alpha(themeColors$2.black, 0.7),
            100: themeColors$2.black,
        },
    },
    secondary: {
        lighter: lighten(themeColors$2.secondary, 0.85),
        light: lighten(themeColors$2.secondary, 0.25),
        main: themeColors$2.secondary,
        dark: darken(themeColors$2.secondary, 0.2),
    },
    primary: {
        lighter: lighten(themeColors$2.primary, 0.85),
        light: lighten(themeColors$2.primary, 0.3),
        main: themeColors$2.primary,
        dark: darken(themeColors$2.primary, 0.2),
    },
    success: {
        lighter: lighten(themeColors$2.success, 0.85),
        light: lighten(themeColors$2.success, 0.3),
        main: themeColors$2.success,
        dark: darken(themeColors$2.success, 0.2),
    },
    warning: {
        lighter: lighten(themeColors$2.warning, 0.85),
        light: lighten(themeColors$2.warning, 0.3),
        main: themeColors$2.warning,
        dark: darken(themeColors$2.warning, 0.2),
    },
    error: {
        lighter: lighten(themeColors$2.error, 0.85),
        light: lighten(themeColors$2.error, 0.3),
        main: themeColors$2.error,
        dark: darken(themeColors$2.error, 0.2),
    },
    info: {
        lighter: lighten(themeColors$2.info, 0.85),
        light: lighten(themeColors$2.info, 0.3),
        main: themeColors$2.info,
        dark: darken(themeColors$2.info, 0.2),
    },
};
const PureLightTheme = createTheme({
    ...
    colors: {
        ...
        secondary: {
            lighter: alpha(themeColors$2.secondary, 0.1),
            light: lighten(themeColors$2.secondary, 0.3),
            main: themeColors$2.secondary,
            dark: darken(themeColors$2.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$2.primary, 0.1),
            light: lighten(themeColors$2.primary, 0.3),
            main: themeColors$2.primary,
            dark: darken(themeColors$2.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$2.success, 0.1),
            light: lighten(themeColors$2.success, 0.3),
            main: themeColors$2.success,
            dark: darken(themeColors$2.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$2.warning, 0.1),
            light: lighten(themeColors$2.warning, 0.3),
            main: themeColors$2.warning,
            dark: darken(themeColors$2.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$2.error, 0.1),
            light: lighten(themeColors$2.error, 0.3),
            main: themeColors$2.error,
            dark: darken(themeColors$2.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$2.info, 0.1),
            light: lighten(themeColors$2.info, 0.3),
            main: themeColors$2.info,
            dark: darken(themeColors$2.info, 0.2),
        },
    ...
    components: {
        MuiBackdrop: {
            styleOverrides: {
                root: {
                    backgroundColor: alpha(darken(themeColors$2.primaryAlt, 0.4), 0.2),
                    backdropFilter: 'blur(2px)',
                    '&.MuiBackdrop-invisible': {
                        backgroundColor: 'transparent',
                        backdropFilter: 'blur(2px)',
        ...
        MuiList: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiListItem-root.MuiButtonBase-root.Mui-selected': {
                        backgroundColor: alpha(colors$2.primary.lighter, 0.4),
                    },
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$2.primary.lighter, 0.4),
                    },
            ...
            styleOverrides: {
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$2.alpha.black[100],
                            background: alpha(colors$2.primary.lighter, 0.4),
                        },
                    },
                },
            },
            ...
            styleOverrides: {
                root: {
                    '&.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$2.alpha.black[100],
                            background: lighten(colors$2.primary.lighter, 0.5),
                        },
                    },
                },
            },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$2.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$2.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
...
const colors$1 = {
    ...
    layout: {
        ...
        sidebar: {
            ...
            menuItemIconColor: lighten(themeColors$1.secondary, 0.5),
    ...
    alpha: {
        white: {
            5: alpha(themeColors$1.white, 0.02),
            10: alpha(themeColors$1.white, 0.1),
            30: alpha(themeColors$1.white, 0.3),
            50: alpha(themeColors$1.white, 0.5),
            70: alpha(themeColors$1.white, 0.7),
        ...
        black: {
            5: alpha(themeColors$1.black, 0.02),
            10: alpha(themeColors$1.black, 0.1),
            30: alpha(themeColors$1.black, 0.3),
            50: alpha(themeColors$1.black, 0.5),
            70: alpha(themeColors$1.black, 0.7),
            100: themeColors$1.black,
        },
    },
    secondary: {
        lighter: lighten(themeColors$1.secondary, 0.85),
        light: lighten(themeColors$1.secondary, 0.25),
        main: themeColors$1.secondary,
        dark: darken(themeColors$1.secondary, 0.2),
    },
    primary: {
        lighter: lighten(themeColors$1.primary, 0.85),
        light: lighten(themeColors$1.primary, 0.3),
        main: themeColors$1.primary,
        dark: darken(themeColors$1.primary, 0.2),
    },
    success: {
        lighter: lighten(themeColors$1.success, 0.85),
        light: lighten(themeColors$1.success, 0.3),
        main: themeColors$1.success,
        dark: darken(themeColors$1.success, 0.2),
    },
    warning: {
        lighter: lighten(themeColors$1.warning, 0.85),
        light: lighten(themeColors$1.warning, 0.3),
        main: themeColors$1.warning,
        dark: darken(themeColors$1.warning, 0.2),
    },
    error: {
        lighter: lighten(themeColors$1.error, 0.85),
        light: lighten(themeColors$1.error, 0.3),
        main: themeColors$1.error,
        dark: darken(themeColors$1.error, 0.2),
    },
    info: {
        lighter: lighten(themeColors$1.info, 0.85),
        light: lighten(themeColors$1.info, 0.3),
        main: themeColors$1.info,
        dark: darken(themeColors$1.info, 0.2),
    },
};
const PurpleFlowTheme = createTheme({
    // direction: i18n.dir(),
    colors: {
        gradients: {
        ...
        secondary: {
            lighter: alpha(themeColors$1.secondary, 0.1),
            light: lighten(themeColors$1.secondary, 0.3),
            main: themeColors$1.secondary,
            dark: darken(themeColors$1.secondary, 0.2),
        },
        primary: {
            lighter: alpha(themeColors$1.primary, 0.1),
            light: lighten(themeColors$1.primary, 0.3),
            main: themeColors$1.primary,
            dark: darken(themeColors$1.primary, 0.2),
        },
        success: {
            lighter: alpha(themeColors$1.success, 0.1),
            light: lighten(themeColors$1.success, 0.3),
            main: themeColors$1.success,
            dark: darken(themeColors$1.success, 0.2),
        },
        warning: {
            lighter: alpha(themeColors$1.warning, 0.1),
            light: lighten(themeColors$1.warning, 0.3),
            main: themeColors$1.warning,
            dark: darken(themeColors$1.warning, 0.2),
        },
        error: {
            lighter: alpha(themeColors$1.error, 0.1),
            light: lighten(themeColors$1.error, 0.3),
            main: themeColors$1.error,
            dark: darken(themeColors$1.error, 0.2),
        },
        info: {
            lighter: alpha(themeColors$1.info, 0.1),
            light: lighten(themeColors$1.info, 0.3),
            main: themeColors$1.info,
            dark: darken(themeColors$1.info, 0.2),
        },
    ...
    components: {
        MuiBackdrop: {
            styleOverrides: {
                root: {
                    backgroundColor: alpha(darken(themeColors$1.primaryAlt, 0.4), 0.2),
                    backdropFilter: 'blur(2px)',
                    '&.MuiBackdrop-invisible': {
                        backgroundColor: 'transparent',
                        backdropFilter: 'blur(2px)',
        ...
        MuiList: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiListItem-root.MuiButtonBase-root.Mui-selected': {
                        backgroundColor: alpha(colors$1.primary.lighter, 0.4),
                    },
                    '& .MuiMenuItem-root.MuiButtonBase-root:active': {
                        backgroundColor: alpha(colors$1.primary.lighter, 0.4),
                    },
            ...
            styleOverrides: {
                ...
                list: {
                    ...
                    '& .MuiMenuItem-root.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$1.alpha.black[100],
                            background: alpha(colors$1.primary.lighter, 0.4),
                        },
                    },
                },
            },
            ...
            styleOverrides: {
                root: {
                    '&.MuiButtonBase-root': {
                        ...
                        '&:hover, &:active, &.active, &.Mui-selected': {
                            color: colors$1.alpha.black[100],
                            background: lighten(colors$1.primary.lighter, 0.5),
                        },
                    },
                },
            },
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    backgroundColor: alpha(colors$1.alpha.black['100'], 0.95),
                    padding: '8px 16px',
                    fontSize: 13,
                },
                arrow: {
                    color: alpha(colors$1.alpha.black['100'], 0.95),
                },
            },
        },
        MuiSwitch: {
